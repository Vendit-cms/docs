...
| `구독-서비스구독-연간결제.png` | 재현 불가 — 현재 빌드 모달에 연간 결제 토글이 없다 |
| `en-subscription-payment-method.png` | 영어 캡처 완료 |
| `en-subscription-change-payment-date.png` | 영어 캡처 완료 |
| `Setting-Subscription.png` | 재현 불가 — 재고·요금을 구독 중인 업소가 있어야 뜬다 |
| `Setting-Subscription-2.png` | 재현 불가 — 재고·요금을 구독 중인 업소가 있어야 뜬다 |
...
| 이미지 | 상태 |
| --- | --- |
| `채널_연결완료-2.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_연결가능-1.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_연결-1.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_숙소정보_연결된숙소없음.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_숙소연결-1.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_숙소정보.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_예약수수료율.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_채널전송가.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_채널상품.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_채널상품_정보수정.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_채널상품_상품숨김.png` | 채널사 화면 — Dean 이 직접 촬영 |
...
| 이미지 | 상태 |
| --- | --- |
| `notification.png` | 채널사 화면 — Dean 이 직접 촬영 |
...
| 이미지 | 상태 |
| --- | --- |
| `채널_2-3.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_3-2.png` | 채널사 화면 — Dean 이 직접 촬영 |
...
| 이미지 | 상태 |
| --- | --- |
| `채널_수수료_2-1.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_수수료_3-1.png` | 채널사 화면 — Dean 이 직접 촬영 |

## `en/faq/inventory-rate/limit-inventory-by-channel.mdx`

| 이미지 | 상태 |
| --- | --- |
| `채널_17.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_22.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `채널_23.png` | 채널사 화면 — Dean 이 직접 촬영 |
...
| `야놀자시스템오류모달-1.png` | 채널사 화면 — Dean 이 직접 촬영 |
| `설정_숙박업소_알림연락처.png` | 채널사 화면 — Dean 이 직접 촬영 |
